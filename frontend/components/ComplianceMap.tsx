...
export const ComplianceMap: React.FC = () => {
  ...
  return (
    <div
      ...
      className="scada-compliance-panel flex flex-col h-full overflow-hidden text-xs select-none print:bg-white print:text-black print:border-none print:shadow-none"
    >
      {/* Header */}
      <div className="p-3 bg-[#0E1118] border-b border-white/[0.07] flex flex-wrap items-center justify-between gap-2 print:border-b-2 print:border-black">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-[10px] px-2 py-0.5 rounded-[2px] bg-[#131722] text-[#10B981] font-mono border border-white/[0.06] print:bg-gray-200 print:text-black">
        ...
        <button
          onClick={handlePrint}
          className="flex items-center space-x-1.5 bg-[#131722] hover:bg-[#181E2C] text-[#EDEDF0] border border-white/[0.08] px-2.5 py-1 rounded-[3px] transition text-[11px] font-medium print:hidden"
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-3.5 space-y-3 print:overflow-visible print:p-0">
        ...
        <div className="bg-[#131722] p-3 rounded-[4px] border border-white/[0.07] space-y-2 text-[11px] print:bg-gray-50 print:border print:border-gray-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 pt-1 font-mono text-[10px]">
            <div className="bg-[#0E1118] p-2 rounded-[3px] border border-white/[0.05] print:bg-white print:border-gray-300">
            ...
            <div className="bg-[#0E1118] p-2 rounded-[3px] border border-white/[0.05] print:bg-white print:border-gray-300">
              ...
              <span className="text-[#AAB8CE] font-semibold print:text-black">
        ...
        <div className="bg-[#0E1118] rounded-[4px] border border-white/[0.07] overflow-hidden print:border print:border-gray-400">
              ...
              {COMPLIANCE_MAPPING.map((item, idx) => (
                ...
                >
                  ...
                  <td className="p-2.5 text-[#9CA3AF] leading-relaxed align-top font-sans print:text-black">
                    <div className="flex items-start space-x-2">
                      <CheckCircle2 className="w-3.5 h-3.5 text-[#AAB8CE] shrink-0 mt-0.5 print:text-black" />
        ...
        <div className="bg-[#131722] p-2.5 rounded-[3px] border border-white/[0.06] flex items-start space-x-2 text-[10px] text-[#5A6275] print:bg-transparent print:border print:border-gray-300 print:text-gray-700">
          <Info className="w-3.5 h-3.5 text-[#AAB8CE] shrink-0 mt-0.5 print:text-black" />
